          ...
          <div className="row d-flex justify-content-center align-items-center">
            <div className="col-md-5 mb-5">
              <div className={styles.hero_section_contant}>
                ...
                <h5 className={styles.hero_section_title}>Shoppers' Junction</h5>
                <p className={styles.hero_section_para}>
                  Here, you can purchase a wide range of electronics gadgets and accessories. First-time shoppers enjoy a significant discount, and regular customers are eligible for prime membership. Our knowledgeable customer support team is readily available to assist you with any inquiries or concerns you may have during your shopping journey.
                </p>
                  ...
                  return (
                    <div style={{ margin: "30px" }} key={item.id}>
                      <div className={styles.product_wrapper}>
                        ...
                        ></div>
                        <Link to={"./products"} className={styles.view_btn}>
                          Shop Now
                        </Link>
                      </div>
                    </div>
