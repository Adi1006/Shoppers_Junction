    ...
    <>
      <div className={styles.main}>
          ...
          <div className={styles.product_box}>
            ...
            <div className={styles.product_details_box}>
              ...
              <div className={styles.specifications_box}>
                ...
                <div className={styles.specifications_div}>
                  <div className={styles.specifications_title}>Category</div>
                  <div className={styles.specifications_value}>
              ...
              <hr />
              <div className={styles.specifications_div}>
                <div className={styles.specifications_title}>Purchase Price</div>
                <div className={styles.specifications_value}>
                  ₹{totalPrice}
        ...
        <div className={styles.notification}>
          <span className={styles.notification_text}>{`Item added successfully!`}</span>
        </div>
      )}
                <div>
